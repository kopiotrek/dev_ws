...
class CollisionAvoidance(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(LaserScan,'scan',self.measure_dist,10)
        self.publisher_ = self.create_publisher(String, 'cmd_vel', 10)
        self.subscription  # prevent unused variable warning
        timer_period = 0.5  # seconds
        self.timer = self.create_timer(timer_period, self.measure_dist)
        self.i = 0

    def measure_dist(self, msg):
        meas_min_dist = INF
